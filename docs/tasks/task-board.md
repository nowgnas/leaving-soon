...
| T-040 | Add reporter form validation nudges | feature | P1 | IN_PROGRESS | Codex | `/client/src/App.tsx`, `/docs/logs/2026-05.md` | Validate leaving time, seat count, and note length before submit and show inline nudges on invalid fields |
